...
**Hosted Connected Prototype v0.4.11.0 — Authentication & Test Player Support**
...
## v0.4.11.0 Authentication & Test Player Support
...
## v0.4.11.0 Player UI Stabilization
...
## v0.4.11.0 Character Usability & GM Assignment Controls
...
## v0.4.11.0 System Rules Expansion
...
## v0.4.11.0 Essence Milestone Choices
...
## v0.4.11.0 Combat Cards & Power Formatting
...
## v0.4.11.0 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.11.0 Game Night Progression Corrections
...
## v0.4.11.0 Skill XP Advancement & Scaled Power Costs
...
## v0.4.11.0 Weapon Skill Advancement & Compact Player UI
...
## v0.4.11.0 Resolved Power Display
...
## v0.4.11.0 Character Rank Mathematics
...
## v0.4.11.0 Unified Training & Mastery Mathematics
...
## v0.4.11.0 Cumulative Rank Expression Fix
...
## v0.4.11.0 Rank Mutation Resolver Fix
...
## v0.4.11.0 Incremental Training Milestones
...
## v0.4.11.0 Hierarchical Rank Progression
...
## v0.4.11.0 GM Power Deletion
Adds a GM-only Delete Power action in System Data Studio backed by a protected Supabase
RPC. Deletion cleans eligibility, character ownership, loadout, and Daily state references.


## v0.4.11.0 Targeted Power Text Mutation
Adds a Power Rank-Up effect that replaces one specific text expression inside a chosen
Power section, allowing precise progression changes such as Cleave's secondary damage.


## v0.4.11.0 Power Ability & Bronze Breakthrough Progression
