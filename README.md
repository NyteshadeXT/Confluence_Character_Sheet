...
**Hosted Connected Prototype v0.4.10.7 — Authentication & Test Player Support**
...
## v0.4.10.7 Authentication & Test Player Support
...
## v0.4.10.7 Player UI Stabilization
...
## v0.4.10.7 Character Usability & GM Assignment Controls
...
## v0.4.10.7 System Rules Expansion
...
## v0.4.10.7 Essence Milestone Choices
...
## v0.4.10.7 Combat Cards & Power Formatting
...
## v0.4.10.7 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.10.7 Game Night Progression Corrections
...
## v0.4.10.7 Skill XP Advancement & Scaled Power Costs
...
## v0.4.10.7 Weapon Skill Advancement & Compact Player UI
...
## v0.4.10.7 Resolved Power Display
...
## v0.4.10.7 Character Rank Mathematics
...
## v0.4.10.7 Unified Training & Mastery Mathematics
...
## v0.4.10.7 Cumulative Rank Expression Fix
...
## v0.4.10.7 Rank Mutation Resolver Fix
...
## v0.4.10.7 Incremental Training Milestones
...
## v0.4.10.7 Hierarchical Rank Progression
