...
**Hosted Connected Prototype v0.4.10.2 — Authentication & Test Player Support**
...
## v0.4.10.2 Authentication & Test Player Support
...
## v0.4.10.2 Player UI Stabilization
...
## v0.4.10.2 Character Usability & GM Assignment Controls
...
## v0.4.10.2 System Rules Expansion
...
## v0.4.10.2 Essence Milestone Choices
...
## v0.4.10.2 Combat Cards & Power Formatting
...
## v0.4.10.2 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.10.2 Game Night Progression Corrections
...
## v0.4.10.2 Skill XP Advancement & Scaled Power Costs
...
## v0.4.10.2 Weapon Skill Advancement & Compact Player UI
...
## v0.4.10.2 Resolved Power Display
...
## v0.4.10.2 Character Rank Mathematics
...
## v0.4.10.2 Unified Training & Mastery Mathematics
...
## v0.4.10.2 Cumulative Rank Expression Fix
...
## v0.4.10.2 Rank Mutation Resolver Fix
