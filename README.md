...
## v0.4.11.3 Authentication & Test Player Support
...
## v0.4.11.3 Player UI Stabilization
...
## v0.4.11.3 Character Usability & GM Assignment Controls
...
## v0.4.11.3 System Rules Expansion
...
## v0.4.11.3 Essence Milestone Choices
...
## v0.4.11.3 Combat Cards & Power Formatting
...
## v0.4.11.3 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.11.3 Game Night Progression Corrections
...
## v0.4.11.3 Skill XP Advancement & Scaled Power Costs
...
## v0.4.11.3 Weapon Skill Advancement & Compact Player UI
...
## v0.4.11.3 Resolved Power Display
...
## v0.4.11.3 Character Rank Mathematics
...
## v0.4.11.3 Unified Training & Mastery Mathematics
...
## v0.4.11.3 Cumulative Rank Expression Fix
...
## v0.4.11.3 Rank Mutation Resolver Fix
...
## v0.4.11.3 Incremental Training Milestones
...
## v0.4.11.3 Hierarchical Rank Progression
...
## v0.4.11.3 Targeted Power Text Mutation
