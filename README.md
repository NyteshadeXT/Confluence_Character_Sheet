...
**Hosted Connected Prototype v0.4.9.8 — Authentication & Test Player Support**
...
## v0.4.9.8 Authentication & Test Player Support
...
## v0.4.9.8 Player UI Stabilization
...
## v0.4.9.8 Character Usability & GM Assignment Controls
...
## v0.4.9.8 System Rules Expansion
...
## v0.4.9.8 Essence Milestone Choices
...
## v0.4.9.8 Combat Cards & Power Formatting
...
## v0.4.9.8 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.9.8 Game Night Progression Corrections
...
## v0.4.9.8 Skill XP Advancement & Scaled Power Costs
...
## v0.4.9.8 Weapon Skill Advancement & Compact Player UI
...
## v0.4.9.8 Resolved Power Display
...
## v0.4.9.8 Character Rank Mathematics
...
## v0.4.9.8 Unified Training & Mastery Mathematics
