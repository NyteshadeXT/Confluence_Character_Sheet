...
**Hosted Connected Prototype v0.4.10.2.1 — Authentication & Test Player Support**
...
## v0.4.10.2.1 Authentication & Test Player Support
...
## v0.4.10.2.1 Player UI Stabilization
...
## v0.4.10.2.1 Character Usability & GM Assignment Controls
...
## v0.4.10.2.1 System Rules Expansion
...
## v0.4.10.2.1 Essence Progression
...
## v0.4.10.2.1 Essence Milestone Choices
...
## v0.4.10.2.1 Combat Cards & Power Formatting
...
## v0.4.10.2.1 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.10.2.1 Game Night Progression Corrections
...
## v0.4.10.2.1 Skill XP Advancement & Scaled Power Costs
...
## v0.4.10.2.1 Weapon Skill Advancement & Compact Player UI
...
## v0.4.10.2.1 Resolved Power Display
...
## v0.4.10.2.1 Character Rank Mathematics
...
## v0.4.10.2.1 Unified Training & Mastery Mathematics
...
## v0.4.10.2.1 Cumulative Rank Expression Fix
...
## v0.4.10.2.1 Rank Mutation Resolver Fix
