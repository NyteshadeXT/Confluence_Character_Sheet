...
**Hosted Connected Prototype v0.4.10.0 — Authentication & Test Player Support**
...
## v0.4.10.0 Authentication & Test Player Support
...
## v0.4.10.0 Player UI Stabilization
...
## v0.4.10.0 Character Usability & GM Assignment Controls
...
## v0.4.10.0 System Rules Expansion
...
## v0.4.10.0 Essence Milestone Choices
...
## v0.4.10.0 Combat Cards & Power Formatting
...
## v0.4.10.0 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.10.0 Game Night Progression Corrections
...
## v0.4.10.0 Skill XP Advancement & Scaled Power Costs
...
## v0.4.10.0 Weapon Skill Advancement & Compact Player UI
...
## v0.4.10.0 Resolved Power Display
...
## v0.4.10.0 Character Rank Mathematics
...
## v0.4.10.0 Unified Training & Mastery Mathematics
...
## v0.4.10.0 Cumulative Rank Expression Fix
