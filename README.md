...
**Hosted Connected Prototype v0.4.11.1 — Authentication & Test Player Support**
...
## v0.4.11.1 Authentication & Test Player Support
...
## v0.4.11.1 Player UI Stabilization
...
## v0.4.11.1 Character Usability & GM Assignment Controls
...
## v0.4.11.1 System Rules Expansion
...
## v0.4.11.1 Essence Milestone Choices
...
## v0.4.11.1 Combat Cards & Power Formatting
...
## v0.4.11.1 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.11.1 Game Night Progression Corrections
...
## v0.4.11.1 Skill XP Advancement & Scaled Power Costs
...
## v0.4.11.1 Weapon Skill Advancement & Compact Player UI
...
## v0.4.11.1 Resolved Power Display
...
## v0.4.11.1 Character Rank Mathematics
...
## v0.4.11.1 Unified Training & Mastery Mathematics
...
## v0.4.11.1 Cumulative Rank Expression Fix
...
## v0.4.11.1 Rank Mutation Resolver Fix
...
## v0.4.11.1 Incremental Training Milestones
...
## v0.4.11.1 Hierarchical Rank Progression
...
## v0.4.11.1 Targeted Power Text Mutation
