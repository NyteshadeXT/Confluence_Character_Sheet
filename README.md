...
**Hosted Connected Prototype v0.4.10.5 — Authentication & Test Player Support**
...
## v0.4.10.5 Authentication & Test Player Support
...
## v0.4.10.5 Player UI Stabilization
...
## v0.4.10.5 Character Usability & GM Assignment Controls
...
## v0.4.10.5 System Rules Expansion
...
## v0.4.10.5 Essence Milestone Choices
...
## v0.4.10.5 Combat Cards & Power Formatting
...
## v0.4.10.5 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.10.5 Game Night Progression Corrections
...
## v0.4.10.5 Skill XP Advancement & Scaled Power Costs
...
## v0.4.10.5 Weapon Skill Advancement & Compact Player UI
...
## v0.4.10.5 Resolved Power Display
...
## v0.4.10.5 Character Rank Mathematics
...
## v0.4.10.5 Unified Training & Mastery Mathematics
...
## v0.4.10.5 Cumulative Rank Expression Fix
...
## v0.4.10.5 Rank Mutation Resolver Fix
...
## v0.4.10.5 Incremental Training Milestones
...
## v0.4.10.5 Hierarchical Rank Progression
...
## v0.4.10.5 Training Maximum Persistence Fix
