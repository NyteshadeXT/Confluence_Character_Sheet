...
**Hosted Connected Prototype v0.4.9.9 — Authentication & Test Player Support**
...
## v0.4.9.9 Authentication & Test Player Support
...
## v0.4.9.9 Player UI Stabilization
...
## v0.4.9.9 Character Usability & GM Assignment Controls
...
## v0.4.9.9 System Rules Expansion
...
## v0.4.9.9 Essence Milestone Choices
...
## v0.4.9.9 Combat Cards & Power Formatting
...
## v0.4.9.9 Rich Text Render Hotfix
Fixes `esc is not defined` in player Power rendering introduced by v0.4.9.2.


## v0.4.9.9 Game Night Progression Corrections
...
## v0.4.9.9 Skill XP Advancement & Scaled Power Costs
...
## v0.4.9.9 Weapon Skill Advancement & Compact Player UI
...
## v0.4.9.9 Resolved Power Display
...
## v0.4.9.9 Character Rank Mathematics
...
## v0.4.9.9 Unified Training & Mastery Mathematics
...
## v0.4.9.9 Cumulative Rank Expression Fix
